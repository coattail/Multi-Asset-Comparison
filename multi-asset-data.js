window.MULTI_ASSET_SOURCE_DATA = {
  "generatedAt": "2026-04-25T14:34:44.906Z",
  "baseMonth": "2006-01",
  "dates": [
    "2006-01",
    "2006-02",
  ...
  "assets": [
    ...
    },
    {
      ...
      "unit": "指数",
      "availableRange": "2006-01:2025-12"
    },
    {
      "id": "us_cs_lvxrsa",
      "name": "美国房产·拉斯维加斯都会区",
    ...
    },
    {
      ...
      "subgroupLabel": "权益类资产",
      "source": "FRED（SP500）+ datasets/s-and-p-500（月度补齐）",
      "unit": "指数",
  ...
  "sourceNotes": {
    ...
    "us_housing": [
      "https://fred.stlouisfed.org/graph/fredgraph.csv?id=ATXRSA&cosd=2006-01-01",
      "https://fred.stlouisfed.org/graph/fredgraph.csv?id=BOXRSA&cosd=2006-01-01",
      "https://fred.stlouisfed.org/graph/fredgraph.csv?id=CRXRSA&cosd=2006-01-01",
      "https://fred.stlouisfed.org/graph/fredgraph.csv?id=CHXRSA&cosd=2006-01-01",
      "https://fred.stlouisfed.org/graph/fredgraph.csv?id=CEXRSA&cosd=2006-01-01",
      "https://fred.stlouisfed.org/graph/fredgraph.csv?id=DAXRSA&cosd=2006-01-01",
      "https://fred.stlouisfed.org/graph/fredgraph.csv?id=DNXRSA&cosd=2006-01-01",
      "https://fred.stlouisfed.org/graph/fredgraph.csv?id=DEXRSA&cosd=2006-01-01",
      "https://fred.stlouisfed.org/graph/fredgraph.csv?id=LVXRSA&cosd=2006-01-01",
      "https://fred.stlouisfed.org/graph/fredgraph.csv?id=LXXRSA&cosd=2006-01-01",
      "https://fred.stlouisfed.org/graph/fredgraph.csv?id=MIXRSA&cosd=2006-01-01",
      "https://fred.stlouisfed.org/graph/fredgraph.csv?id=MNXRSA&cosd=2006-01-01",
      "https://fred.stlouisfed.org/graph/fredgraph.csv?id=NYXRSA&cosd=2006-01-01",
      "https://fred.stlouisfed.org/graph/fredgraph.csv?id=PHXRSA&cosd=2006-01-01",
      "https://fred.stlouisfed.org/graph/fredgraph.csv?id=POXRSA&cosd=2006-01-01",
      "https://fred.stlouisfed.org/graph/fredgraph.csv?id=SDXRSA&cosd=2006-01-01",
      "https://fred.stlouisfed.org/graph/fredgraph.csv?id=SFXRSA&cosd=2006-01-01",
      "https://fred.stlouisfed.org/graph/fredgraph.csv?id=SEXRSA&cosd=2006-01-01",
      "https://fred.stlouisfed.org/graph/fredgraph.csv?id=TPXRSA&cosd=2006-01-01",
      "https://fred.stlouisfed.org/graph/fredgraph.csv?id=WDXRSA&cosd=2006-01-01"
    ],
    "metals": [
    ...
    "equities": [
      "https://fred.stlouisfed.org/graph/fredgraph.csv?id=SP500&cosd=2006-01-01",
      "https://fred.stlouisfed.org/graph/fredgraph.csv?id=NASDAQ100&cosd=2006-01-01",
